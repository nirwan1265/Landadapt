...
ROOT_OUT = Path('/Users/nirwantandukar/Documents/Github/Landadapt/results/top0.5pct_traits')
...
TRAITS = {
    'soilN': {
        'Arabidopsis': '/Users/nirwantandukar/Documents/Research/results/GWAS/landadapt/arabidopsis/AT_soilN.txt',
        'Rice': '/Users/nirwantandukar/Documents/Research/results/GWAS/landadapt/rice/rice_soilN.txt',
        'Maize': '/Users/nirwantandukar/Documents/Research/results/GWAS/landadapt/maize/maize_soilN.txt',
        'Sorghum': '/Users/nirwantandukar/Documents/Research/results/GWAS/landadapt/sorghum/sorghum_soilN.txt',
        'Barley': '/Users/nirwantandukar/Documents/Research/results/GWAS/landadapt/barley/barley_soilN.txt',
    },
    'PC1': {
        'Arabidopsis': '/Users/nirwantandukar/Documents/Research/results/GWAS/landadapt/arabidopsis/AT_PC1.txt',
        'Rice': '/Users/nirwantandukar/Documents/Research/results/GWAS/landadapt/rice/rice_PC1.txt',
        'Maize': '/Users/nirwantandukar/Documents/Research/results/GWAS/landadapt/maize/maize_PC1.txt',
        'Sorghum': '/Users/nirwantandukar/Documents/Research/results/GWAS/landadapt/sorghum/sorghum_PC1.txt',
        'Barley': '/Users/nirwantandukar/Documents/Research/results/GWAS/landadapt/barley/barley_PC1.txt',
    },
    'PC2': {
        'Arabidopsis': '/Users/nirwantandukar/Documents/Research/results/GWAS/landadapt/arabidopsis/AT_PC2.txt',
        'Rice': '/Users/nirwantandukar/Documents/Research/results/GWAS/landadapt/rice/rice_PC2.txt',
        'Maize': '/Users/nirwantandukar/Documents/Research/results/GWAS/landadapt/maize/maize_PC2.txt',
        'Sorghum': '/Users/nirwantandukar/Documents/Research/results/GWAS/landadapt/sorghum/sorghum_PC2.txt',
        'Barley': '/Users/nirwantandukar/Documents/Research/results/GWAS/landadapt/barley/barley_PC2.txt',
    },
    'PC3': {
        'Arabidopsis': '/Users/nirwantandukar/Documents/Research/results/GWAS/landadapt/arabidopsis/AT_PC3.txt',
        'Rice': '/Users/nirwantandukar/Documents/Research/results/GWAS/landadapt/rice/rice_PC3.txt',
        'Maize': '/Users/nirwantandukar/Documents/Research/results/GWAS/landadapt/maize/maize_PC3.txt',
        'Sorghum': '/Users/nirwantandukar/Documents/Research/results/GWAS/landadapt/sorghum/sorghum_PC3.txt',
        'Barley': '/Users/nirwantandukar/Documents/Research/results/GWAS/landadapt/barley/barley_PC3.txt',
    },
}
...
def run_annotation(gwas_file: str, gff_file: str, out_file: Path) -> None:
    ...
    cmd = [
        'Rscript', str(ANNOT_SCRIPT), gwas_file, gff_file, str(out_file), str(WINDOW_BP)
    ]
...
def top_genes_from_annotated(annot_file: Path):
    ...
    if snp_col is None or p_col is None:
        raise ValueError(f'Cannot detect SNP/P columns in {annot_file}')
    if 'closest_gene' not in df.columns:
        raise ValueError(f'Missing closest_gene in {annot_file}')

    d = df[[snp_col, p_col, 'closest_gene']].copy()
    d = d.dropna(subset=[snp_col, p_col])
    ...
    # max p-value among selected top-snp rows for each gene
...
def build_trait_orthogroups(trait_name, trait_gene_sets, trait_gene_pmax, species_gene_to_odb, odb_to_ogs):
    ...
    df = df[ordered_cols].sort_values(['Gene_count', 'Orthogroup'], ascending=[False, True])
    return df
