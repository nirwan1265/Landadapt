...
\section{Results}
We analyzed cross-species genotype--environment associations for soil nitrogen, soil pH, climate PCs (PC1--PC3), and AM fungal colonization traits. To keep interpretation clear, each subsection below first defines the phenotype and then summarizes the GWAS and shared-orthogroup results.

\input{results/mixed_window_10kb_csv/cross_species_top0p5_mixed_window_10kb_sections.tex}
