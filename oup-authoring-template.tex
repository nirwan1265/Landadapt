...
To place these recurrence patterns in the broader context of species-specific GWAS signal, we next summarized cross-trait variation in Bonferroni-significant SNP counts, mapped candidate-gene counts, and orthogroup overlap across all environmental phenotypes (Fig.~\ref{fig:figx_cross_species_gwas_summary}). Bonferroni-significant SNP counts varied substantially across both traits and species (Fig.~\ref{fig:figx_cross_species_gwas_summary}A), indicating strong heterogeneity in the magnitude of species-specific association signal. The number of genes recovered from the upper-ranked association sets also varied across species and traits, but remained consistently large enough to support downstream orthogroup-based comparisons (Fig.~\ref{fig:figx_cross_species_gwas_summary}B). Despite these large candidate-gene sets, only a small number of orthogroups were shared across all five species for any given trait (Fig.~\ref{fig:figx_cross_species_gwas_summary}C), whereas orthogroups shared across at least four species were more common and showed stronger cross-trait variation (Fig.~\ref{fig:figx_cross_species_gwas_summary}D). Soil pH and soil nitrogen showed the highest recurrence across four or more species, followed by AM fungal roots colonized and the WorldClim principal components, whereas aridity showed the weakest all-five-species overlap. These broad patterns provide the comparative context for the trait-specific results described below.

Together, these results indicate that the observed recurrence of shared orthogroups is greater than expected under a matched candidate-universe null, supporting non-random cross-species recurrence while leaving open the need for future SNP-level null calibration.
...
\begin{figure*}[t]
    \centering
    \includegraphics[width=\textwidth]{Figs/Supplementary/SuppFig_null_permutation_orthogroup_recurrence.png}
    ...
    \label{fig:suppfig_null_permutation_orthogroup_recurrence}
\end{figure*}

\begin{figure*}[t]
    \centering
    \includegraphics[width=\textwidth]{Figs/FigX/FigX_cross_species_gwas_summary.png}
    ...
    \label{fig:figX_cross_species_gwas_summary}
\end{figure*}
